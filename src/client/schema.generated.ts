...
export enum MediaItemSizeEnum {
  /** MediaItem with the archive-thumbnail size */
 ...
 * The template assigned to the node
 */
export interface Template_Dashboard {
  __typename?: "Template_Dashboard";
  /**
   * The name of the template
   */
  templateName?: Maybe<ScalarsEnums["String"]>;
 ...
 * The template assigned to the node
 */
export interface Template_SecuredPage {
  __typename?: "Template_SecuredPage";
  /**
   * The name of the template
   */
  templateName?: Maybe<ScalarsEnums["String"]>;
...
export interface SchemaObjectTypes {
  ...
  Template_SecuredPage: Template_SecuredPage;
